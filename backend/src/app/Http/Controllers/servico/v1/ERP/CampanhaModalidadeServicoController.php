...
class CampanhaModalidadeServicoController extends BaseServicoController
{

    public function __construct()
    {
        $this->nomeCamposDb = self::_nomeCamposDb();
        $this->tabela = TABELA_CAMPANHA_MODALIDADE;
        parent::__construct($this, $this->nomeCamposDb, $this->tabela);
        $this->filha = $this;
        $this->metodo = 'Campanhamodalidade' . CLASS_SERVICE;
        $this->entity = CampanhaModalidadeServicoController::class;
    ...
    {
        return parent::store($dados, CampanhaModalidade::class, ["id_campanha", "id_retaguarda"], self::_nomeCamposDb());
    }

    public function atualizarInserirVetores($dados)
    {
        return parent::storeVetores($dados, CampanhaModalidade::class, ["id_campanha", "id_retaguarda"], self::_nomeCamposDb());
    }
