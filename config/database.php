    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'username' => env('DB_USERNAME', 'painel_temporario'),
        ...
        'system' => [
            ...
            'username' => env('SYSTEM_USERNAME', 'painel_temporario'),
            'password' => env('SYSTEM_PASSWORD', '123456'),
            'unix_socket' => env('SYSTEM_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'ovh' => [
            'central' => [
                'host' => env('OVH_CENTRAL_HOST', '127.0.0.1'),
            ],
            'tenant' => [
                'host' => env('OVH_TENANT_HOST', '10.1.1.108'),
            ],
        ],
