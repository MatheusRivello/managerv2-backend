...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('tenant')->create('campanha_requisito', function (Blueprint $table) {
            ...
            $table->double('quantidade_max')->nullable();
            $table->double('percentual_desconto')->nullable();
            $table->tinyInteger('obrigatorio')->nullable();
    ...
    {
        Schema::connection('tenant')->dropIfExists('campanha_requisito');
    }
};
